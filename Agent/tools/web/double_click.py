...
class DoubleClickTool(BaseTool):
    ...
    def description(self) -> str:
        return "Double click an element by index. Use this when a single click is not enough"
    ...
    def get_parameters_schema(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                "element_index": {
                    "type": "integer",
                    "description": "The index number of the element to double click from the UI elements list (1-based)",
                    "minimum": 1
                }
            },
